...
export class CatogoryServiceProxy {
    ...
    getAllCategories(): Observable<CategoryDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Catogory/GetAllCategories";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getByCategoryId(categoryId: number | undefined): Observable<CategoryDto> {
        let url_ = this.baseUrl + "/api/services/app/Catogory/GetByCategoryId?";
        if (categoryId === null)
    ...
    protected processGetByCategoryId(response: HttpResponseBase): Observable<CategoryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class TodoServiceProxy {
     ...
     * @return Success
     */
    create(body: TodoDto | undefined): Observable<TodoDto> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TodoDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TodoDto>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processCreate(response: HttpResponseBase): Observable<TodoDto> {
        ...
        return _observableOf<TodoDto>(<any>null);
    }
    ...
    getAllTodos(): Observable<TodoDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Todo/GetAllTodos";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAllTodos(response: HttpResponseBase): Observable<TodoDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getById(todoId: number | undefined): Observable<TodoDto> {
        let url_ = this.baseUrl + "/api/services/app/Todo/GetById?";
        if (todoId === null)
    ...
    protected processGetById(response: HttpResponseBase): Observable<TodoDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getByCategoryId(categoryId: number | undefined): Observable<TodoDto[]> {
        let url_ = this.baseUrl + "/api/services/app/Todo/GetByCategoryId?";
        if (categoryId === null)
            throw new Error("The parameter 'categoryId' cannot be null.");
        else if (categoryId !== undefined)
            url_ += "categoryId=" + encodeURIComponent("" + categoryId) + "&";
    ...
    protected processGetByCategoryId(response: HttpResponseBase): Observable<TodoDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<TodoDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<TodoDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TodoDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processGetAll(response: HttpResponseBase): Observable<TodoDtoPagedResultDto> {
        ...
        return _observableOf<TodoDtoPagedResultDto>(<any>null);
    }
}
